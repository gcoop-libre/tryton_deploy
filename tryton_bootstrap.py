...
password = getpass.getpass("Ingrese el password de admin a utilizar en la base '%s': " % db_name)

#Si la base de datos no existe, proteus la crea :)
config = config.set_trytond(db_name, 'admin', 'postresql', LANGUAGE, password, CONFIG_FILE)
